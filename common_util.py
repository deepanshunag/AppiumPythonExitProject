...
import time
'''
the common methods are click, getData and is present which we call multiple times.
to keep the code short and easy to understand all of them have been implemented in 
this class and called whenever needed.
'''
